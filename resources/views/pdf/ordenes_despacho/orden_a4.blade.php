...
<body>
    ...
    <div>
        ...
        <p><strong>N° Despacho:</strong> {{ $venta->serie_orden }} | <strong>Cliente:</strong>
            {{ $venta->cliente->razon_social }} | <strong>Fecha Despacho:</strong>
        ...
        <table>
            ...
            <tbody>
                @foreach ($venta->detalles as $detalle)
                    <tr>
                        <td>{{ $detalle->presentacion_pollo_descripcion }} / {{ $detalle->tipo_pollo_descripcion }}
                        </td>
                        {{-- <td></td> --}}
